...
pub const LINK_DOCS_HOME: &str = "https://rd.gzbit.com/";
pub const LINK_DOCS_X11_REQUIRED: &str = "https://rd.gzbit.com/docs/en/manual/linux/#x11-required";
pub const LINK_HEADLESS_LINUX_SUPPORT: &str =
    "https://rd.gzbit.com/rustdesk/rustdesk/wiki/Headless-Linux-Support";
lazy_static::lazy_static! {
    pub static ref HELPER_URL: HashMap<&'static str, &'static str> = HashMap::from([
        ("docs home", LINK_DOCS_HOME),
        ("docs x11-required", LINK_DOCS_X11_REQUIRED),
...
pub const RENDEZVOUS_SERVERS: &[&str] = &["rd.gzbit.cn"];
pub const RS_PUB_KEY: &str = "dfqxMDxl2zGxDwcYkGzmyQr1jqYfQMahg+GOwVdHt34=";
